...
object HeroesData {
    private val data = arrayOf(
        arrayOf(
            "Ahmad Dahlan",
            "Salah seorang ulama dan khatib terkemuka di Masjid Besar Kasultanan " +
                    ...
                    "Ngayogyakarta Hadiningrat pada masa itu. KH. Ahmad Dahlan telah " +
                    "mempelopori kebangkitan ummat Islam untuk menyadari nasibnya " +
        ...
        arrayOf(
            "Ahmad Yani",
            "Jenderal TNI Anumerta Ahmad Yani (juga dieja Achmad Yani; lahir " +
                    ...
                    " Nasional Indonesia Angkatan Darat, dan dibunuh oleh anggota Gerakan" +
        ...
        arrayOf(
            "Sutomo",
            "Sutomo (lahir di Surabaya, Jawa Timur, 3 Oktober 1920 – meninggal" +
                    " di Padang Arafah, Arab Saudi, 7 Oktober 1981 pada umur 61 tahun) " +
                    ...
                    "tentara NICA, yang berakhir dengan pertempuran 10 November 1945 " +
        ...
        arrayOf(
            ...
            "Dr.(H.C.) Ir. H. Soekarno (ER, EYD: Sukarno, nama lahir: Koesno Sosrodihardjo) " +
                    ...
                    "pada umur 69 tahun) adalah Presiden pertama Republik Indonesia yang menjabat pada" +
                    " periode 1945–1967. Ia memainkan peranan penting dalam memerdekakan bangsa Indonesia " +
        ...
        arrayOf(
            ...
            "Prof. Mr. Dr. Soepomo (Ejaan Soewandi: Supomo; lahir di Sukoharjo, Jawa Tengah, " +
                    ...
                    " adalah seorang panatella nasional Indonesia. Soepomo dikenal sebagai arsitek " +
                    "Undang-undang Dasar 1945, bersama dengan Muhammad Yamin dan Soekarno.",
            "https://upload.wikimedia.org/wikipedia/commons/8/80/Soepomo.jpg"
        ),
        arrayOf(
            "Tan Malaka",
            "Tan Malaka atau Ibrahim gelar Datuk Sutan Malaka " +
                    "(lahir di Nagari Pandam Gadang, Suliki, Lima Puluh Kota, Sumatera " +
                    "Barat, 2 Juni 1897 – meninggal di Desa Selopanggung, Kediri, Jawa " +
                    "Timur, 21 Februari 1949 pada umur 51 tahun) adalah seorang pembela" +
                    " kemerdekaan Indonesia, tokoh Partai Komunis Indonesia, juga " +
                    "pendiri Partai Murba, dan merupakan salah satu Pahlawan Nasional" +
                    " Indonesia.",
